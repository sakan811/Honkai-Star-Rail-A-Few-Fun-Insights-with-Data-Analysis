...
class ChartConfig:
    ...
    font_scale_by_chart: Dict[str, Dict[str, float]] = field(default_factory=get_default_font_scale_by_chart)
    ...
    chart_sizes: Dict[str, Tuple[int, int]] = field(default_factory=get_default_chart_sizes)
    ...
    grid_settings: Dict[str, Dict[str, Any]] = field(default_factory=get_default_grid_settings)
    legend_settings: Dict[str, Dict[str, Any]] = field(default_factory=get_default_legend_settings)
    annotation_settings: Dict[str, Dict[str, Any]] = field(default_factory=get_default_annotation_settings)
    marker_settings: Dict[str, Dict[str, Any]] = field(default_factory=get_default_marker_settings)
    ...
    # Import getter methods from config_properties module
    get_font_size = get_font_size
    get_size = get_size
    get_colormap = get_colormap
    get_title = get_title
    get_grid_settings = get_grid_settings
    get_legend_settings = get_legend_settings
    get_annotation_settings = get_annotation_settings
    get_marker_settings = get_marker_settings
