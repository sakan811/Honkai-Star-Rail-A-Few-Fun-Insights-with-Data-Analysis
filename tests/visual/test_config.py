...
def test_font_size_calculation(default_config):
    ...
    assert default_config.title_fontsize == int(
        default_config.base_fontsize * 1.4 * default_config.font_scale
    )
    assert default_config.label_fontsize == int(
        default_config.base_fontsize * 1.2 * default_config.font_scale
    )
    assert default_config.tick_fontsize == int(
        default_config.base_fontsize * 1.0 * default_config.font_scale
    )
    assert default_config.legend_fontsize == int(
        default_config.base_fontsize * 1.0 * default_config.font_scale
    )
    assert default_config.annotation_fontsize == int(
        default_config.base_fontsize * 0.9 * default_config.font_scale
    )
