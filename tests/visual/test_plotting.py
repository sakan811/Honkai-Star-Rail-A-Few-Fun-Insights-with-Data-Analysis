...
def element_path_data():
    ...
    return pd.DataFrame({
        "Element": ["Fire", "Ice", "Lightning", "Wind", "Quantum", "Imaginary", "Physical"],
...
def path_rarity_data():
    ...
    return pd.DataFrame({
        "Path": ["Destruction", "Hunt", "Erudition", "Harmony", "Nihility", "Preservation", "Abundance"],
        "Rarity": ["5-star", "5-star", "5-star", "5-star", "5-star", "5-star", "5-star",
...
def test_plot_rarity_element_distribution():
    ...
    with patch("hsrws.visual.plotting.plotting_bar.plt") as mock_plt, \
...
def test_plot_element_balance_evolution():
    ...
    with patch("hsrws.visual.plotting.plotting_area.plt") as mock_plt, \
