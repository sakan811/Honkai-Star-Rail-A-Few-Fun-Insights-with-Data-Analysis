...
def mock_data_utils():
    ...
    with patch("hsrws.visual.charts.get_latest_patch") as mock_latest_patch, \
         patch("hsrws.visual.charts.get_element_path_heatmap_data") as mock_heatmap_data, \
         patch("hsrws.visual.charts.get_rarity_element_distribution_data") as mock_rarity_data, \
         patch("hsrws.visual.charts.get_version_release_timeline_data") as mock_timeline_data, \
         patch("hsrws.visual.charts.get_element_balance_evolution_data") as mock_evolution_data, \
         patch("hsrws.visual.charts.get_path_rarity_distribution_data") as mock_path_data:
...
def mock_plotting():
    ...
    with patch("hsrws.visual.charts.plot_element_path_heatmap") as mock_heatmap_plot, \
         patch("hsrws.visual.charts.plot_rarity_element_distribution") as mock_rarity_plot, \
         patch("hsrws.visual.charts.plot_version_release_timeline") as mock_timeline_plot, \
         patch("hsrws.visual.charts.plot_element_balance_evolution") as mock_evolution_plot, \
